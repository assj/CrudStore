defmodule CrudStore.Product do
  import Ecto.Changeset
  import Ecto.Query
  use CrudStore.Web, :model
  ...
  def clear_db do
    CrudStore.Product |> CrudStore.Repo.delete_all()
  end

  def insert_product(attrs) do
    CrudStore.Repo.insert(struct(CrudStore.Product, attrs))
  end

  def list_all() do
    query = from(p in CrudStore.Product, select: p)
    CrudStore.Repo.all(query)
  end
